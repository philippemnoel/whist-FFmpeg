...
// Metal #define ALIGN (HAVE_AVX512 ? 64 : (HAVE_AVX ? 32 : 16))
...
void *av_dynarray2_add(void **tab_ptr, int *nb_ptr, size_t elem_size,
  ...
  FF_DYNARRAY_ADD(
      INT_MAX, elem_size, *tab_ptr, *nb_ptr,
      {
...
void *av_fast_realloc(void *ptr, unsigned int *size, size_t min_size) {
  ...
  min_size =
      FFMIN(max_alloc_size, FFMAX(min_size + min_size / 16 + 32, min_size));
